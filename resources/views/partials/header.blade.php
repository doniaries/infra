        ...
        <div class="container px-4 mx-auto">
            <div class="relative flex items-center justify-between -mx-4">
                <div class="max-w-full px-4 w-60">
                    <a href="/" class="flex items-center gap-5 w-full py-5 navbar-logo">
                        <img src="{{ asset('images/kabupaten-sijunjung.png') }}" alt="Logo Kabupaten Sijunjung"
                            style="height:48px; width:auto;" />
                        <div class="flex items-center gap-7">
                            <div>
                                <h1 class="app-title m-0"
                                    style="font-size:1.2rem; font-weight:600; color:#0f0f0f; line-height:1.1;">
                                    Help Desk Infrastruktur TI
                                </h1>
                            </div>
                            ...
                            <ul class="blcok lg:flex 2xl:ml-20">
                                <li class="relative group">
                                    <a href="{{ route('public.laporform') }}"
                                        class="flex py-2 mx-8 text-base font-medium text-dark dark:text-white group-hover:text-primary dark:group-hover:text-primary lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                                        <i class="fas fa-plus-circle me-1"></i>
                                        <span class="font-bold">Buat Laporan</span>
                                    </a>
                                </li>
                                <li class="relative group">
                                    <a href="{{ route('list.laporan') }}"
                                        class="flex py-2 mx-8 text-base font-medium text-dark dark:text-white group-hover:text-primary dark:group-hover:text-primary lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                                        Daftar Laporan
                                    </a>
                                </li>
